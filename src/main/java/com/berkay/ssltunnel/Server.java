...
public class Server extends Thread{
	...
	public Server(int ServerSecureSocketListenPort, int ServerLocalListenPort, String destinationIp, String Key) throws Exception{
	...
	public void run() {
		...
		TrayManager tm = new TrayManager("Secure Socket TCP Server(" + destinationIp + ":" + ServerLocalListenPort + ")");	//Tray Icon Yarat
		...
		try {
			...
			while (true) {
				...
				new ServerHelper(socket,ServerLocalListenPort,destinationIp).start();
			}
